<?php
  ...
  //New features of Website Version 7:
  
  //Loyalty points fixed
  //Deals code created
  //Deals code implemented artificially
  //Loacalised Bootstrap
  //Deals Code fully implemented
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
                ...
                <div class="carousel-caption">
                    <a href="product.php?id=1012" id="carousel_links_black">
                    <h3>Soap</h3>
